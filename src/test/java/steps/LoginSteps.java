...
public class LoginSteps extends CommonMethods {
    ...
    public void admin_user_is_successfully_logged_in() {
        ...
        Assert.assertTrue(dash.pimOption.isDisplayed());
        Assert.assertTrue(dash.welcomeMessage.isDisplayed());
        Assert.assertEquals("Welcome " + ConfigReader.getPropertyValue("username"), dash.welcomeMessage.getText());
        System.out.println("(Test Passed) Admin User Is Successfully Logged In: " + dash.welcomeMessage.getText());
        tearDown();
    }
    ...
    public void ess_user_is_successfully_logged_in() {
        DashBoardPage dash = new DashBoardPage();
        Assert.assertTrue(dash.welcomeMessage.isDisplayed());
        Assert.assertEquals("Welcome Johnny", dash.welcomeMessage.getText());
        System.out.println("(Test Passed) ESS User Is Successfully Logged In: " + dash.welcomeMessage.getText());
        tearDown();
    ...
    public void user_see_invalid_credentials_message_on_login_page() {
        ...
        System.out.println("(Test Passed) Invalid credentials message appeared: " + login.errorMessage.getText());
        tearDown();
    }
    ...
    //Class 4 errorvalidation
    @When("user enters invalid credentials and clicks on login and verify the error")
    public void user_enters_invalid_credentials_and_clicks_on_login_and_verify_the_error(io.cucumber.datatable.DataTable errorValidation) {
