...
public class APIWorkFlowSteps {
    ...
    public void the_retrieved_employee_id_should_match_the_globally_stored_employee_id(String employeeIdFromResponse) {
        ...
        String tempEmpIdResponse = response.jsonPath().getString(employeeIdFromResponse);
        Assert.assertEquals(employee_id, tempEmpIdResponse);
    }
    ...
    /*
    ************************** Dynamic Creating Employee ************************
     */

    @Given("a request is prepared fr creating an employee with dynamic data {string}, {string},{string},{string},{string},{string},{string}")
    public void a_request_is_prepared_fr_creating_an_employee_with_dynamic_data(String emp_firstname, String emp_lastname,
